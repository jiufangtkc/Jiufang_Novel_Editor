...
> 執行結果：**85/85 全數通過**（Phase 16 Plan 02 全面修復完畢）
...
| 文件 | 問題 | 狀態 |
|---|---|---|
| [ARCHITECTURE.md](file:///c:/Users/yenfu/OneDrive/JiuFangTKC/655.AI_agent/Jiufang_Novel_Editor/ARCHITECTURE.md) | 1. 最後更新標記更新至 2026-08-30<br>2. 單元測試數量更新為 **85 項**<br>3. 修正為 **11 個子控制器**<br>4. 補充 `app_settings_service.py` 與 `backup_service.py` | ✅ 已完成 |
| [HANDOVER.md](file:///c:/Users/yenfu/OneDrive/JiuFangTKC/655.AI_agent/Jiufang_Novel_Editor/HANDOVER.md) | 1. 最後更新標記更新至 2026-08-30<br>2. 測試數量更新為 **85/85**<br>3. 補充 Phase 16 修復紀錄與 MARK_COLOR_MAP 陷阱提示 | ✅ 已完成 |
| [ROADMAP.md](file:///c:/Users/yenfu/OneDrive/JiuFangTKC/655.AI_agent/Jiufang_Novel_Editor/ROADMAP.md) | 1. Phase 15 標記為完成<br>2. 新增 Phase 16 狀態與成果 | ✅ 已完成 |
| [workspace_rules.md](file:///c:/Users/yenfu/OneDrive/JiuFangTKC/655.AI_agent/Jiufang_Novel_Editor/.agents/rules/workspace_rules.md) | 1. 更新重要檔案索引指引<br>2. 修正陷阱章節參照（第 3 節）<br>3. 補充 MARK_COLOR_MAP 規範 | ✅ 已完成 |
| [OPTIMIZATION_PLAN.md](file:///c:/Users/yenfu/OneDrive/JiuFangTKC/655.AI_agent/Jiufang_Novel_Editor/OPTIMIZATION_PLAN.md) | 全部 10 個子階段已完成（保留作為歷史紀錄） | ✅ 已完工 |
...
| **B5** | **低** | [card_controller.py:317](file:///c:/Users/yenfu/OneDrive/JiuFangTKC/655.AI_agent/Jiufang_Novel_Editor/controllers/card_controller.py#L317) | **右鍵選單「全部展開」的 lambda 綁定邏輯多餘**。第 317 行 `act_expand.triggered.connect(item.setExpanded if True else None)` 始終為真，多連接了一次 `setExpanded` method reference（非 callable with argument），不會崩潰但屬於冗餘代碼。 |
